...
<qgis version="2.18.20" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="mytext">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="myint">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="asdssa">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="name" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="false" symbol="0" value="Line" label="Line"/>
      <category render="false" symbol="1" value="Polygon" label="Polygon"/>
      <category render="false" symbol="2" value="Point" label="Point"/>
    </categories>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="mytext" index="2" name=""/>
    <alias field="myint" index="3" name=""/>
    <alias field="asdssa" index="4" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;asdssad&quot;" sortOrder="1">
    <columns>
      <column width="-1" hidden="0" type="field" name="id"/>
      <column width="-1" hidden="0" type="field" name="name"/>
      <column width="-1" hidden="1" type="actions"/>
      <column width="-1" hidden="0" type="field" name="mytext"/>
      <column width="-1" hidden="0" type="field" name="myint"/>
      <column width="-1" hidden="0" type="field" name="asdssa"/>
    </columns>
  </attributetableconfig>
  <editform>../../.qgis2/python/plugins/QuickDigitize/addattribute.ui</editform>
  <editforminit/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="mytext" expression=""/>
    <default field="myint" expression=""/>
    <default field="asdssa" expression=""/>
  </defaults>
